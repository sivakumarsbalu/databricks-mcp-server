...
def create_server() -> Server:
    ...
    try:
        ...
        logger.info(f"Connected to Databricks at {databricks.config.host}")
    ...
    async def list_all_tools() -> list[Tool]:
        """List all available Databricks tools."""
        tools = []
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "spark_version": {
                                "type": "string",
                                "description": "Spark version (e.g., '13.3.x-scala2.12')",
                            },
                            "node_type_id": {
                                "type": "string",
                            ...
                            "autotermination_minutes": {
                                "type": "integer",
                                "description": "Auto-termination timeout",
                                "default": 120,
                            },
                        },
            ...
            [
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "path": {
                                "type": "string",
                                "description": "Full path to notebook",
                            }
                        },
                        "required": ["path"],
                    },
                ...
                Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "path": {"type": "string", "description": "Path for folder"}
                        },
                        "required": ["path"],
                    },
                ),
